...
$html = '<div class="alert alert-info">Заполните заголовки и тексты. Пустые строки будут пропущены. Активные шаблоны будут показаны в выпадающем меню в редакторе.</div>';
