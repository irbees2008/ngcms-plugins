...
<form method="post" action="?mod=extra-config&amp;plugin=ads_pro&amp;action=[add]add_submit[/add][edit]edit_submit[/edit]">
	...
	<table class="table table-sm">
		...
		<tr>
			<td width="50%" class="contentEntry1">{l_ads_pro:description}<br/>
		...
		<tr>
			<td width="50%" class="contentEntry1">{l_ads_pro:type}<br/>
				<small>{l_ads_pro:type_d}</small>
			</td>
			<td width="50%" class="contentEntry2">{type_list}</td>
		</tr>
		<tr>
			<td width="50%" class="contentEntry1">{l_ads_pro:location}<br/>
		...
		<tr>
			<td width="50%" class="contentEntry1">{l_ads_pro:state}<br/>
				<small>{l_ads_pro:state_d}</small>
			</td>
	...
	<fieldset>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" class="contentEntry1">{l_ads_pro:start_view}<br/>
			...
			<tr>
				<td width="50%" class="contentEntry1">{l_ads_pro:end_view}<br/>
