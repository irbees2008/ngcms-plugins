		...
		{% for entry in entries %}
			...
			{% if entry.type == 'textarea' %}
				<tr>
					<td width="30%">{{ entry.title }}</td>
					<td width="70%">
						<textarea name="{{ entry.name }}" style="width: 380px; height: 160px" class="textarea"/>{{ entry.value }}</td>
				</tr>
			</textarea>
		</td>
	</tr>
...
{% endif %}{% endfor %}{% if captcha_widget %}
<tr>
	<td colspan="2">
