...
for ($i = 1; $i <= $count; $i++) {
	...
	array_push($cfgX, array('name' => 'rss' . $i . '_url', 'title' => 'Адрес новостей для отображения<br /><small>Например: <b>http://ngcms.org</b></small>', 'type' => 'input', 'value' => extra_get_param($plugin, 'rss' . $i . '_url')));
