...
- **Использование:**
  ...
  ```php
  // Просмотр итогов
  logger('Total: count=' . $tCount . ', price=' . $tPrice . ', IP=' . get_ip(), 'info', 'basket.log');
...
```
[2026-01-29 17:30:10] [INFO] Total: count=3, price=2500.00, IP=192.168.1.100
[2026-01-29 17:30:15] [INFO] List: count=3, total=2500.00, IP=192.168.1.100
[2026-01-29 17:30:20] [INFO] Update: updated=2, deleted=1, IP=192.168.1.100

[2026-01-29 17:35:10] [INFO] Feedback show: formID=5, count=2, total=1800.00, IP=192.168.1.100
[2026-01-29 17:35:30] [INFO] Feedback process: formID=5, count=2, total=1800.00, IP=192.168.1.100
[2026-01-29 17:35:31] [INFO] Feedback notify: formID=5, cleared=2 items, IP=192.168.1.100
```

**Путь к логам:** engine/cache/logs/basket.log
